...
import com.msaggik.sixthlessonlifecycleofafragment.fragments.FirdFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    // поля
    private Button buttonFirstFragment, buttonSecondFragment, buttonFirdFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonFirdFragment = findViewById(R.id.button_fird_fragment);

        // обработка нажатия кнопок
        buttonFirstFragment.setOnClickListener(listener);
        buttonSecondFragment.setOnClickListener(listener);
        buttonFirdFragment.setOnClickListener(listener);
    }
        ...
        public void onClick(View view) {
            ...
            switch (view.getId()) {
                ...
                case R.id.button_second_fragment:
                    ...
                    break;
                case R.id.button_fird_fragment:
                    fragment = new FirdFragment();
                    break;
            }
